...
\fancyhead[R]{Cessna 172M, 1974 (N20865)}
...
\begin{checklist}{Runup}
    ...
    \item{Carb heat}{off}
    \item{Throttle}{$1000$ rpm}
    \item{Throttle Friction}{adjust}
    \item{Mixture}{lean \sfrac{3}{4} inch}
    \item{Primer}{in \& locked}
...
\begin{checklist}{Takeoff briefing}
    ...
    \simpleitem{$V_a$\ $97$ at 2300lbs, $80$ at 1600lbs}
\end{checklist}
...
\begin{checklist}{Pre-Maneuver}
    ...
    \item{Carb heat}{as required}
    \item{Lights}{as required}
    \item{Ignition}{both}
    \item{Master Switch}{on}
    \item{Primer}{in \& locked}
    \item{Clearing turns}{complete}
\end{checklist}
